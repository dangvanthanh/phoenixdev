defmodule Phoenixdev.Charts do
  def get_line_stack_data(cumulative \\ nil) do
    {
      ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
      Enum.map(
        [
          %{name: "Email", values: [120, 132, 101, 134, 90, 230, 210]},
          %{name: "Union Ads", values: [220, 182, 191, 234, 290, 330, 310]},
          %{name: "Video Ads", values: [150, 232, 201, 154, 190, 330, 410]},
          %{name: "Direct", values: [320, 332, 301, 334, 390, 330, 320]},
          %{name: "Search Engine", values: [820, 932, 901, 923, 1290, 1330, 1320]}
        ],
        fn line_data ->
